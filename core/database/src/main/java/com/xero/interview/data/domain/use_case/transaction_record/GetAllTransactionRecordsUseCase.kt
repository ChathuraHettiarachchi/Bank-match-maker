...
class GetAllTransactionRecordsUseCase @Inject constructor(private val repo: TransactionRecordRepo) {
    operator fun invoke(bankAccountId: Long): Flow<List<TransactionRecord>> = flow {
